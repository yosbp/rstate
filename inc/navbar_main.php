...
<nav class="navbar navbar-expand-lg mx-auto ">
    <div class="container">
      <a href='index.php'><img class="navbar_main_logo" src="img/Logo_prop-removebg-preview.png"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto me-auto mb-2 mb-lg-0 w-75">
          <li class="nav-item">
            <a class="navbar_main_link nav-link active" href="index.php?view=search&trAll=Compra">Compra</a>
          </li>
          <li class="nav-item">
            <a class="navbar_main_link nav-link active" href="index.php?view=search&trAll=Alquiler">Alquiler</a>
          </li>
          <li class="nav-item">
